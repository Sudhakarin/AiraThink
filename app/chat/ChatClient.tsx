...
function isVerified(username?: string) {
  return ["sudhakarin", "tanushree2251", "shikhamishra", "instagram"].includes(
            ...
            <div className="px-5 py-6">
              ...
              <div className="glass mt-6 divide-y divide-black/5 dark:divide-white/5 overflow-hidden rounded-2xl">
                <div className="flex items-center justify-between px-4 py-3.5">
                  ...
                  <input value={nameDraft} onChange={(e) => setNameDraft(e.target.value)} className="w-40 bg-transparent text-right text-sm outline-none" />
                </div>
                <div className="flex items-center justify-between px-4 py-3.5">
                ...
                <div className="flex items-center justify-between px-4 py-3.5">
                  ...
                  <span className="inline-flex items-center text-sm">@{myProfile.username}{isVerified(myProfile.username) && <VerifiedBadge />}</span>
                </div>
